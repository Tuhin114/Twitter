        ...
        <div className='max-w-screen-xl mx-auto flex h-screen px-10'>
            ...
            <div className='flex-1 flex flex-col justify-center items-center'>
                <form className='lg:w-2/3 mx-auto md:mx-20 flex gap-4 flex-col' onSubmit={handleSubmit}>
                    <XSvg className='w-24 lg:hidden fill-white' /> {/* XSvg for mobile view */}
                    <h1 className='text-4xl font-extrabold text-white'>Join today.</h1> {/* Form heading */}
                    ...
                    <button className='btn rounded-full btn-primary text-white'>Sign up</button> {/* Submit button */}
                    {isError && <p className='text-red-500'>Something went wrong</p>} {/* Error message */}
                </form>
